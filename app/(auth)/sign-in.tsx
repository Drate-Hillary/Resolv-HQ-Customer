  ...
  return (
    <SafeAreaView className="flex-1 bg-white">
      <KeyboardAvoidingView className="flex-1" behavior={Platform.OS === "ios" ? "padding" : undefined}>
        <ScrollView
          contentContainerStyle={{ flexGrow: 1, paddingHorizontal: 28, paddingTop: 40 }}
        ...
        >
          <Animated.View entering={FadeInDown.duration(400)}>
            ...
            <Text className="mt-1 font-manrope-medium text-[14px] text-neutral-500">
              Sign in to continue to Resolv HQ
            </Text>
          </Animated.View>
          ...
          <Animated.View entering={FadeInDown.delay(100).duration(400)} className="mt-9">
            ...
            >
              <Text className="font-manrope-semibold text-[13px] text-black">
                Forgot password?
              </Text>
            </AnimatedPressable>
          ...
          <Animated.View
            ...
            className="flex-row items-center justify-center gap-1.5 pb-8 pt-6"
          >
            <Text className="font-manrope-medium text-[13px] text-neutral-500">
              Don&apos;t have an account?
            </Text>
            <AnimatedPressable onPress={() => router.push("/sign-up")}>
              <Text className="font-manrope-bold text-[13px] text-black">Sign Up</Text>
            </AnimatedPressable>
          </Animated.View>
        </ScrollView>
      </KeyboardAvoidingView>
